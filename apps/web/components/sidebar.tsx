...
const NAV = [
  ...
  { href: "/tasks", label: "Tasks", icon: TasksIcon, pending: true },
  { href: "/compliance", label: "Compliance", icon: ComplianceIcon, pending: true },
  { href: "/documents", label: "Documents", icon: DocumentsIcon, pending: true },
  { href: "/employees", label: "Employees", icon: EmployeesIcon },
  { href: "/reports", label: "Reports", icon: ReportsIcon, pending: true },
